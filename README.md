...
- GitHub Actions build production memakai `VITE_API_BASE_URL=https://alpardfm.my.id/api/moneypath`
- path API production Moneypath sekarang dipisah per project agar tidak bentrok dengan project lain di domain yang sama
  - docs Swagger: `https://alpardfm.my.id/api/moneypath/swagger/index.html`
  - OpenAPI raw: `https://alpardfm.my.id/api/moneypath/openapi.json`
